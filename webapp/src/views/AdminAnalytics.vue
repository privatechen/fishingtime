        ...
        <div v-else class="chart">
          <svg viewBox="0 0 100 100" preserveAspectRatio="none" aria-label="近7天用户趋势">
            ...
            <circle v-for="(item, index) in data.daily" :key="item.date"
              ...
              :cy="88 - (72 * item.uv) / maxUv" r="1.8" class="dot" />
          </svg>
          <div class="x-axis">
